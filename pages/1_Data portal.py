...
# Default fallbacks (used if no CSV is provided or CSV is malformed)
    # I don't belive that this will get used again, unless everything disappears from the dropbox/GitHub :) 
    ...
    if not observer or not hotel_code:
        ...
        if not photo:
            ...
            if rows_to_save:
                ...
                st.info("❌ No data are provided, that's okay but please go back up and, for a single hole, select 'Empty' for the Scientific name")
